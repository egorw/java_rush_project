...
public class Solution {
    ...
    public static void cleanAllApartments(List<Apartment> apartments) {
        ...
        for (int i = 0; i < apartments.size(); i++){
            ...
            else if (apartments.get(i) instanceof Apt2Room) ((Apt2Room) apartments.get(i)).clean2Rooms();
            else if (apartments.get(i) instanceof Apt3Room) ((Apt3Room) apartments.get(i)).clean3Rooms();
        }
