...
public class Solution {
    ...
    public static final String UNIC_BINDING_NAME_CAT = "cat.string";
    public static final String UNIC_BINDING_NAME_DOG = "dog.string";
    ...
    public static Thread SERVER_THREAD = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            } catch (RemoteException | AlreadyBoundException d) {
